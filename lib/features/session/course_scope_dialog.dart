...
Future<RecurringCourseEditScope?> showRecurringCourseEditScopeDialog(
  BuildContext context,
) {
  final l10n = AppLocalizations.of(context)!;
  return showDialog<RecurringCourseEditScope>(
    context: context,
    builder: (context) => SimpleDialog(
      title: Text(l10n.courseScopeTitle),
      children: [
        SimpleDialogOption(
          onPressed: () =>
              Navigator.pop(context, RecurringCourseEditScope.single),
          child: _ScopeOption(
            icon: Icons.event_outlined,
            label: l10n.courseScopeSingle,
          ),
        ...
        SimpleDialogOption(
          ...
          child: _ScopeOption(
            ...
            label: l10n.courseScopeMeetingFromSelected,
          ),
        ),
        SimpleDialogOption(
          onPressed: () =>
              Navigator.pop(context, RecurringCourseEditScope.meetingAll),
          child: _ScopeOption(
            icon: Icons.event_repeat_outlined,
            label: l10n.courseScopeMeetingAll,
          ),
        ),
        SimpleDialogOption(
          onPressed: () =>
              Navigator.pop(context, RecurringCourseEditScope.courseCommon),
          child: _ScopeOption(
            icon: Icons.calendar_month_outlined,
            label: l10n.courseScopeCourseCommon,
          ),
        ),
      ],
    ),
